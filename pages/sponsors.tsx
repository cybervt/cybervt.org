...
const sponsors: Sponsor[] = [
	...
	{
		name: 'Commonwealth Cyber Initiative Southwest Virginia',
		url: 'https://cyberinitiative-swva.org/',
		sponsorType: 'Silver',
		description: 'CCI SWVA is one of the four regional nodes of the Commonwealth Cyber Initiative (CCI), which was founded in 2019 to establish Virginia as a global center of excellence at the intersection of cybersecurity, autonomy, and intelligence.',
		logoLocation: '/img/sponsors/CCI.png',
		lastDonation: new Date('2026-08-01'),
	},
	{
		name: 'EC-Council',
		...
		sponsorType: 'Silver',
		description: 'EC-Council offers globally recognized certifications to help you advance your career in today’s cyber landscape.',
		logoLocation: '/img/sponsors/ECCouncil.jpg',
		lastDonation: new Date('2026-08-01'),
	},
	{
